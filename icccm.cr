...
fun xcb_get_wm_class_from_reply(x0 : Pointer(xcb_get_wm_class_reply_t, x1 : Pointer(xcb_get_property_reply_t)) : UInt8 
																...
																fun xcb_get_wm_transient_for_reply(Pointer(xcb_connection_t), xcb_get_property_cookie_t, Pointer(xcb_window_t), Pointer(Pointer(xcb_generic_error_t)) : UInt8 
																									 ...
																									 XCB_WM_HINT_WINDOW_GROUP)
																														 ...
																														 UInt32 xcb_wm_hints_get_urgency(xcb_wm_hints_t *hints):

																															 Void xcb_wm_hints_set_input(xcb_wm_hints_t *hints, UInt8 input):
																											 ...
																											 xcb_get_property_cookie_t xcb_get_wm_hints(xcb_connection_t *c,
																													 ...
																													 UInt8 xcb_get_wm_hints_reply(xcb_connection_t *c,
																													 ...
																													 Void xcb_set_wm_protocols_checked(xcb_connection_t *c, xcb_atom_t wm_protocols,
																																xcb_window_t window, UInt32 list_len,
																																xcb_atom_t *list):
																													...
																													struct {
																														 ...
																														 xcb_get_property_cookie_t xcb_get_wm_protocols(xcb_connection_t *c,
																																							...
																																							xcb_get_property_cookie_t xcb_get_wm_protocols_unchecked(xcb_connection_t *c,
																																																...
																																																UInt8 xcb_get_wm_protocols_reply(xcb_connection_t *c,
																																								 xcb_get_property_cookie_t cookie,
